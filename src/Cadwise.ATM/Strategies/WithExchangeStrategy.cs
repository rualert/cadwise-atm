...
/// <summary>
/// Стратегия выбора купюр с разменом
/// </summary>
public class WithExchangeStrategy:IBanknotesSelectionStrategy
{
    public Dictionary<int, int> CalculateBanknotesForAmount(int amount, IEnumerable<AtmCashCassette> cashCassettes)
    {
        ...
        foreach (var cassette in cashCassettes.OrderBy(x => x.BanknoteDenomination))
        {
